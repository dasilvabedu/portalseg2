...
def dadoExtenso():
    ...
    resultadoMetadadoTabela, resultadoMetadadoAtributo, retorno, mensagemRetorno = acessoBanco.leMetadado(
        None, "mtt_metadadotabela", None, "Sim"
    )
    resultadoFinal = acessoBanco.montaRetorno(retorno, mensagemRetorno)
    if retorno != 200:
        return resultadoFinal, retorno, header
    ...
    resultadoAtributoTabela, resultadoAtributoAtributo, retorno, mensagemRetorno = acessoBanco.leMetadado(
        None, "mta_metadadoatributo", None, "Sim"
    )
    resultadoFinal = acessoBanco.montaRetorno(retorno, mensagemRetorno)
    if retorno != 200:
        return resultadoFinal, retorno, header
